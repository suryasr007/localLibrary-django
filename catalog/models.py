...
class BookInstance(models.Model):
    ...
    """
    id = models.UUIDField(primary_key = True, default=uuid.uuid4, help_text = "Model representing a specific copy of a book (i.e. that can be borrowed from the library).")
